...
import { Flame, ChevronRight, Play, Brain, Zap, Activity, Dumbbell, Disc3, Clock, ArrowRight } from "lucide-react";
...
const SkateIcon = ({ className, size }: { className?: string; size?: number }) => (
  ...
  >
    ...
    <path d="M10 8.5l3 2" />
    <path d="M10 11l3 2" />
    <path d="M10.5 13.5l2.5 1.5" />
    <path d="M7 19h10" />
    <path d="M8 19c.5 1.5 2 2.5 4 2.5s3.5-1 4-2.5" />
  </svg>
);
