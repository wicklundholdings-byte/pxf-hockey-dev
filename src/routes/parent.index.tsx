              ...
              >
                <img
                  ...
                  onError={(e) => {
                    ...
                    if (parent && !parent.querySelector("[data-puck-fallback]")) {
                      const div = document.createElement("div");
                      div.setAttribute("data-puck-fallback", "true");
                      div.className = "flex h-full w-full items-center justify-center bg-surface-2";
                      div.innerHTML = '<div class="grid h-10 w-10 place-items-center rounded-full bg-background/60 text-muted-foreground"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="12" rx="9" ry="4"/><path d="M3 12v3c0 2.2 4 4 9 4s9-1.8 9-4v-3"/></svg></div>';
